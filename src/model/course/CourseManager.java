...
public class CourseManager implements Manager {
	 ...
	 * @author benni
	 */
	private void restore(List<Map<String, Object>> loadCoursesDescription) {
	...
	public void load() {
		...
		courseDescription = (List<Map<String, Object>>) ConfigXML.load(
				KEY_PATH_FILE, KEY_VERSION_FILE);
	 ...
	 * 
	 * @param courseId
	 * @return the Course object which has the specified course id
	 */

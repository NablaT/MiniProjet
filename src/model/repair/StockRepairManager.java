...
public class StockRepairManager {
	 ...
	 * 
	 *            this method add a new object Repair to listOfProducts if the
	 *            ArrayList materials is empty the method do nothing
	 */
	public void addMaterial(ArrayList<Material> materials, GregorianCalendar end) {
		if (materials.size() != 0) {
